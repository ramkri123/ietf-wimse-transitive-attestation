...
: A nonce provided by the Resource Server or WIA specifically for the workload-to-agent fusion flow. It is distinct from the platform-level nonce (**N_platform**) used to verify the WIA itself.
